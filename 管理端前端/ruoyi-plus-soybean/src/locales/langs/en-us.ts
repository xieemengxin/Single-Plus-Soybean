const local: App.I18n.Schema = {
  ...
  page: {
    login: {
      common: {
        title: 'Modern enterprise-level microservice management system',
      ...
      totp: {
        ...
        bindTip: 'Scan the QR code with Google Authenticator, then enter the 6-digit code',
        verifyTip: 'Enter the 6-digit code from your authenticator app',
        manualKey: 'Cannot scan? Enter the key manually',
        codePlaceholder: 'Please enter the 6-digit code',
        verify: 'Verify',
        backToLogin: 'Back to Login',
        expired: 'The verification session has expired, please login again'
      }
    },
    home: {
      branchDesc:
    ...
    about: {
      title: 'About',
      introduction: `RuoYi-Plus-Soybean is a modern, enterprise-level microservice management system. It combines the powerful backend capabilities of RuoYi-Vue-Plus with the modern frontend features of Soybean Admin, providing developers with a complete enterprise management solution.`,
      projectInfo: {
        title: 'Project Info',
        version: 'Version',
