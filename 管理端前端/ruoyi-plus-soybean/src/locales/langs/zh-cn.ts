const local: App.I18n.Schema = {
  ...
  page: {
    login: {
      ...
      totp: {
        title: '两步验证',
        bindTip: '请使用 Google Authenticator 等认证器扫描二维码绑定，然后输入 6 位动态口令',
        verifyTip: '请输入认证器中的 6 位动态口令',
        manualKey: '无法扫码？手动输入密钥',
        codePlaceholder: '请输入 6 位动态口令',
        verify: '验证',
        backToLogin: '返回登录',
        expired: '两步验证会话已失效，请重新登录'
      }
    },
    home: {
      branchDesc:
    ...
    about: {
      title: '关于',
      introduction: `RuoYi-Plus-Soybean 是一个现代化的企业级微服务管理系统，它结合了 RuoYi-Vue-Plus 的强大后端功能和 Soybean Admin 的现代化前端特性，为开发者提供了完整的企业管理解决方案。`,
      projectInfo: {
        title: '项目信息',
        version: '版本',
