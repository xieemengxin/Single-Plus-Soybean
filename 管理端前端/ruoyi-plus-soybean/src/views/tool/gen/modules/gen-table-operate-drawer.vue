...
const infoRules: Record<InfoRuleKey, App.Global.FormRule> = {
  ...
  frontendType: defaultRequiredRule,
          ...
          <NTabPane name="genInfo" tab="生成信息" display-directive="show">
            ...
            >
              <NGrid :x-gap="16" responsive="screen" item-responsive>
                ...
                <NFormItemGi span="24 s:12" label="前端模板类型" path="frontendType">
                  <template #label>
                    <div class="flex-center">
                      <FormTip content="生成的前端代码模板，本前端工程请选择 soybean" />
                      <span class="pl-3px">前端模板类型</span>
                    </div>
                  </template>
                  <NSelect
                    v-model:value="genTableInfo.info.frontendType"
                    :options="genFrontendTypeOptions"
                    placeholder="请选择前端模板类型"
                  />
                </NFormItemGi>
              </NGrid>
